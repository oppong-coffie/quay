...
export default function Featured({ products = [] }: FeaturedProps) {
  ...
  return (
    <section className="w-full px-6 md:px-12 lg:px-16 py-12 md:py-16 bg-zinc-50 dark:bg-zinc-900/10 transition-colors duration-200">
            ...
            >
              <div>
                ...
                <div
                  ...
                  className="relative aspect-[3/4] rounded-3xl overflow-hidden mb-4 bg-zinc-100 dark:bg-zinc-900/65 shadow-sm border border-zinc-200/50 dark:border-zinc-800/50 cursor-pointer"
                >
                  <img
                    src={prod.image}
                    alt={prod.name}
                  ...
                  <div
                    ...
                    className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent flex items-end justify-center p-4 pt-12 z-10"
                  >
                    <button
                ...
                {/* Product Info */}
                <div className="px-1 cursor-pointer" onClick={() => handleViewDetails(prod)}>
